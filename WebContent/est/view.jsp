	 ...
	 <div class="container">
		 ...
		 <div class="jumbotron">
		 	<div class="row" align="center">
		 		...
		 		if(userID !=null){
		 		%>
			 		<a href="update.jsp?conNum=<%=conNum %>" class="btn btn-primary pull-right"> 수정하기 </a>
			 		<a onclick="return confirm('정말로 삭제하시겠습니까?')"href="deleteAction.jsp?conNum=<%=conNum %>" class="btn btn-primary pull-right"> 삭제하기 </a>
		 		<%
		 		} 
		 		%>
		 		</div>
