	 ...
	 <div class="container">
		 ...
		 <div class="jumbotron">
		 	<div class="row" align="center">
		 		<h1 >신규 고객 등록</h1>
		 		<br>
		 		<form method="post" action="writeClientsAction.jsp">
			 		<table class="table table.stripted" style="text-align:center;border:1px solid #dddddd " >
			 			<thead>				
			 				<tr>
			 					<th colspan="2" style ="background-color:#eeeeee; text-align:center;">고객 정보 작성란</th>
			 					
			 				</tr>
			 			</thead>
			 			<tbody>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="성함" 
			 					name="cliName" maxlength="50"></td>
			 				</tr>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="연락처" 
			 					name="cliPhone" maxlength="20"></td></tr>
			 				<tr>	
			 					<td><input type="text" class="form-control" placeholder="생년월일" 
			 					name="cliBirth" maxlength="20"></td>
			 				</tr>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="이메일" 
			 					name="cliEmail" maxlength="50"></td>
			 				</tr>
			 			</tbody>
