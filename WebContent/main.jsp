...
<!-- 네비게이션(웹사이트 구성을 보여주는 역할) -->
	<nav class="navbar navbar-default" style="background-color:#FFE3EE;">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="User/index.jsp">사용자 페이지</a><li>
						</ul>
					</li>
				</ul>	
	 ...
	 <div class="container">
	 	<div class="jumbotron">
	 		<div class="container">
	 			<h1>Bill house Interior</h1>
	 			<p>관리자 Administrator</p>
	 			<%if(userID==null){ %>
	 			<p align="center"><a class="btn btn-primary btn-pull" href="login.jsp" role="button">관리자 로그인</a></p>
	 			<%} %>
	 			<%if(userID!=null){ %>
	 			<p align="center"><a class="btn btn-primary btn-pull" href="Consult.jsp" role="button">상담 관리</a></p>
	 			<%} %>
	 		</div>
	 	</div>
	 </div>
