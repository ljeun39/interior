				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="User/main.jsp">사용자 페이지</a><li>
						</ul>
					</li>
				</ul>	
			<%
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="table-responsive">
        	<form action="ChargeAS.jsp" method="post">
		 		<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
		 			...
		 			<tbody>
		 					...
		 					<%
		 						...
		 						ArrayList<ChargeAS> list = chargeASDAO.getList(pageNumber);
		 					...
		 					%>
		 			 			...
		 			 			<tr>
		 		 					...
		 		 					<td><td><a href="asView.jsp?asNum=<%= list.get(i).getConNum() %>"><%=list.get(i).getAsDetail()%></a></a></td>
		 		 					<td><%=list.get(i).getAsBudget()%></td>
		 		 				</tr>		 		 				
		 		 			<%
		 						}}
		 					%>
 			...
 			<%
				if(pageNumber != 1){
			%>
			<a href ="ChargeAS.jsp?pageNumber=<%=pageNumber -1 %>" class="btn btn-primary pull-left">이전</</a>
	 		<%
				}
 				if(chargeASDAO.nextPage(pageNumber+1)){
			%>
			<a href ="ChargeAS.jsp?pageNumber=<%=pageNumber +1 %>" class="btn btn-primary pull-left">다음</</a>	 		
			<%
				}
			%>

			<a href="writeChargeAS.jsp" class="btn btn-primary pull-right">AS 추가</a>
				<%
		 		if(userID !=null){
		 		%>
