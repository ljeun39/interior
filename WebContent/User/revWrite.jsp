...
<!--   네비게이션바     -->
	...
	<h1>후기 목록</h1><br><br>
		<div class="row">
			<form method="post" action="revWriteAction.jsp">
				<table class="table table-striped" style="text-align:center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="2" style="background-color:#eeeeee; text-align:center;">후기 작성</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td> <input type="text" class="form-control" placeholder="제목" name="revTitle" maxlength="50"></td>
						</tr>
						<tr>
							<td> <textarea class="form-control" placeholder="내용" name="revContent" maxlength="2048" style="height:350px;"></textarea></td>
						</tr>
						<!--   파일 업로드 
						<tr>
							<td>
