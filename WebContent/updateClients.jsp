	 ...
	 <div class="container">
		 ...
		 <div class="jumbotron">
		 	<div class="row" align="center">
		 		<h1 > 고객 정보 게시판</h1>
		 		<br>
		 		<form method="post" action="updateClientsAction.jsp?cliNum=<%=cliNum%>">
			 		<table class="table table.stripted" style="text-align:center;border:1px solid #dddddd " >
			 			...
			 			<tbody>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="고객이름" 
			 					name="cliName" maxlength="50" value="<%=clients.getCliName()%>"></td>
			 				</tr>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="연락처" 
			 					name="cliPhone" maxlength="20" value="<%=clients.getCliPhone()%>"></td></tr>
			 				<tr>	
			 					<td><input type="text" class="form-control" placeholder="생년월일" 
			 					name="cliBirth" maxlength="20" value="<%=clients.getCliBirth()%>"></td>
			 				</tr>
			 				<tr>
			 					<td><input type="text" class="form-control" placeholder="이메일" 
			 					name="cliEmail" maxlength="50" value="<%=clients.getCliEmail()%>"></td>
			 				</tr>
			 			</tbody>
			 		</table>	 		
